...
PID: 46730, TID: 1560137, Thread name: (none), Queue name: com.apple.NSURLSession-work, QoS: 0
Backtrace:
4   MartHoliday                         0x00000001068c29a3 -[NMapDownloadOperation dealloc] + 264
5   libobjc.A.dylib                     0x00000001073e9a6e _ZN11objc_object17sidetable_releaseEb + 202
6   CFNetwork                           0x000000010c8e6332 -[NSURLConnectionInternal _withConnectionAndDelegate:onlyActive:] + 191
7   CFNetwork                           0x000000010c93ee89 -[NSURLConnectionInternal _withConnectionAndDelegate:] + 45
8   CFNetwork                           0x000000010c93ee56 -[NSURLConnectionInternal _withConnectionDisconnectFromConnection] + 70
9   CFNetwork                           0x000000010c8e2d59 _ZN27URLConnectionClient_Classic11setDelegateEPK24CFURLConnectionClient_V1 + 147
10  CFNetwork                           0x000000010c92a1bc ___ZN27URLConnectionClient_Classic15invalidateAsyncEP16dispatch_queue_sU13block_pointerFvvE_block_invoke_2 + 32
11  CFNetwork                           0x000000010c92a17e ___ZN27URLConnectionClient_Classic15invalidateAsyncEP16dispatch_queue_sU13block_pointerFvvE_block_invoke + 213
12  CFNetwork                           0x000000010c8d3f64 ___ZNK25URLConnectionInstanceData18withWorkQueueAsyncEU13block_pointerFvvE_block_invoke + 16
13  libdispatch.dylib                   0x000000010beed7ab _dispatch_call_block_and_release + 12
14  libdispatch.dylib                   0x000000010beee7ec _dispatch_client_callout + 8
15  libdispatch.dylib                   0x000000010bef6be5 _dispatch_queue_serial_drain + 1305
16  libdispatch.dylib                   0x000000010bef74fa _dispatch_queue_invoke + 328
17  libdispatch.dylib                   0x000000010bef3344 _dispatch_queue_override_invoke + 726
18  libdispatch.dylib                   0x000000010befa36c _dispatch_root_queue_drain + 664
19  libdispatch.dylib                   0x000000010befa076 _dispatch_worker_thread3 + 132
20  libsystem_pthread.dylib             0x000000010c4181ca _pthread_wqthread + 1387
21  libsystem_pthread.dylib             0x000000010c417c4d start_wqthread + 13
2018-08-14 15:24:12.028238+0900 MartHoliday[46730:1560137] [reports] Main Thread Checker: UI API called on a background thread: -[UIApplication setNetworkActivityIndicatorVisible:]
PID: 46730, TID: 1560137, Thread name: (none), Queue name: com.apple.NSURLSession-work, QoS: 0
Backtrace:
4   MartHoliday                         0x00000001068c29a3 -[NMapDownloadOperation dealloc] + 264
5   libobjc.A.dylib                     0x00000001073e9a6e _ZN11objc_object17sidetable_releaseEb + 202
...
20  libsystem_pthread.dylib             0x000000010c4181ca _pthread_wqthread + 1387
21  libsystem_pthread.dylib             0x000000010c417c4d start_wqthread + 13
2018-08-14 15:26:53.821697+0900 MartHoliday[46730:1560033] [MC] System group container for systemgroup.com.apple.configurationprofiles path is /Users/jeonmijin/Library/Developer/CoreSimulator/Devices/DEF6C5DE-5A0F-4E69-9213-8552CE3EAEF4/data/Containers/Shared/SystemGroup/systemgroup.com.apple.configurationprofiles
2018-08-14 15:26:53.822682+0900 MartHoliday[46730:1560033] [MC] Reading from private effective user settings.
```
...
- 즐겨찾기 모델 구현
- 테스트 코드 짜기
- json이 변경되어도 그대로 즐겨찾기가 유지되고 업데이트되는지 확인
...
```
예비 / 진짜 state로 들어가는거 꼭 두개씩 호출되는데 어떻게 구분하고 함수를 구현해야하는지?
